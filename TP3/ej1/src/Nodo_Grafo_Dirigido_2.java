...
public class Nodo_Grafo_Dirigido_2{
	...
	public boolean fijar_valores_de_verdad(boolean valor){
		if(this.valores_de_verdad.valor_fijado && this.valores_de_verdad.valor_de_verdad!=valor){
			return false;
		}
		this.valores_de_verdad.valor_fijado = true;
		this.valores_de_verdad.valor_de_verdad = valor;
		return true;
	}
	public boolean valor_de_verdad(){
		return this.valores_de_verdad.valor_de_verdad;
	}
	public boolean valor_esta_fijado(){
		return this.valores_de_verdad.valor_fijado;
	}
