...
public class GeneradorCasosDeTestsbyPortales {
	
	private int cantidadDePisos;
	private int longitudDePasillos;

	GeneradorCasosDeTestsbyPortales(int cantidadDePisos, int longitudDePasillos, int escala, int cantMinimaPortales, int cantMaximaPortales) throws Exception
	{
		this.cantidadDePisos = cantidadDePisos;
		this.longitudDePasillos = longitudDePasillos;
		
		int cantPortales = cantMinimaPortales;
