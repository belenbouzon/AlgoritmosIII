...
public class Tester_correctitud {
	@Test
	public static void test_oficial_1(){
	...
	@Test
	public static void test_oficial_2(){
	...
	@Test
	public static void no_quiero_caminar(){
	...
	@Test
	public static void cuello_botella(){
	...
	public static void main(String [] entrada){
		...
		Tester_correctitud.test_oficial_1();
		
		
		Tester_correctitud.test_oficial_2();
		...
		Tester_correctitud.no_quiero_caminar();
		
		Tester_correctitud.cuello_botella();
