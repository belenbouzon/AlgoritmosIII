...
public class Fogon {
	private TreeMap<Integer,Integer> exploradoras_con_amigas;
	...
	public Fogon(int cantidad_exploradoras){
		...
		this.exploradoras_con_amigas = new TreeMap<Integer,Integer> ();
	...
	private int calcular_alteracion_distancias(Exploradora exploradora,int posicion){ //O(a ln a)
		int res = 0;
		Iterator<Integer> it = exploradora.amigas_de();
	...
	public Map<Integer,Integer> devolver_ronda(){
